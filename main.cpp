...
int main() {
    ...
    while(option != "Ex"){
        if (option == "Add") {
            ...
            //std::cout << "Trapeze area " << id << calc_area(Trap) << std::endl;
        }else if(option == "Rem") {
            ...
            std::cin >> val;
            std::cout << "The number of figures with an area less than a given "<< std::count_if(t.begin(),t.end(), [val](Trapeze<int> Trap)
            {return Trap.area_ < val;})  << std::endl;
        } else if (option == "Menu") {
